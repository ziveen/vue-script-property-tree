...
export function activate(context: vscode.ExtensionContext) {
  ...
  const treeView = vscode.window.createTreeView("vuePropertiesMap", {
  ...
  context.subscriptions.push(
    vscode.commands.registerCommand("extension.refreshVueFunctions", () => {
  ...
  context.subscriptions.push(
    vscode.commands.registerCommand("jumpToProperty", (filePath, pos) => {
