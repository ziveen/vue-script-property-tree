...
export class VueFnMapProvider implements vscode.TreeDataProvider<any> {
    private _onDidChangeTreeData: vscode.EventEmitter<VueTreeItem | undefined | void> = new vscode.EventEmitter<VueTreeItem | undefined | void>;
    readonly onDidChangeTreeData?: vscode.Event<VueTreeItem | undefined | void> = this._onDidChangeTreeData.event;
